...
public class PanelCrearComanda extends JPanel {
    ...
    public PanelCrearComanda(Coordinador coordinador, CoordinadorNegocio coordinadorNegocio) throws NegocioException {
    ...
    public void mostrar() throws NegocioException {
        ...
        String mesaActual = coordinadorNegocio.getMesaActual();
        JLabel labelTitulo = new JLabel("Mesa: " + (mesaActual != null ? mesaActual : "sin seleccionar"));
        ...
        buttonEliminar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    DefaultTableModel modeloCuentaLocal = (DefaultTableModel) tablaCuenta.getModel();
                    int cantidadActual = (int) modeloCuentaLocal.getValueAt(filaSeleccionadaC, 1);

                    if (cantidadActual > 1) {
                        modeloCuentaLocal.setValueAt(cantidadActual - 1, filaSeleccionadaC, 1);
                        if (filaSeleccionadaP >= 0) {
                            Object subtotal = tablaProductos.getValueAt(filaSeleccionadaP, 2);
                            double precioUnitario = Double.parseDouble(subtotal.toString());
                            double calcularSubtotal = Double.parseDouble(
                                tablaCuenta.getValueAt(filaSeleccionadaC, 2).toString());
                            modeloCuentaLocal.setValueAt(calcularSubtotal - precioUnitario, filaSeleccionadaC, 2);
                        }
                    } else {
                        modeloCuentaLocal.removeRow(filaSeleccionadaC);
                    }
