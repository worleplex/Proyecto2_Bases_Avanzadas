...
/**
 * Dialogo de interfaz grafica para el registro de ingredientes.
...
public class DialogFormularioIngrediente extends JDialog {
    ...
    private void initComponents() {
        ...
        JLabel titulo = new JLabel("Registro de Ingrediente", SwingConstants.CENTER);
    ...
    /**
     * Abre un selector de archivos para permitir al usuario elegir una imagen
     * desde su equipo.
     */
